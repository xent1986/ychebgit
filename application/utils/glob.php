<?php
 function glob_definePerpage($tmp)
 {
    switch ($tmp)
    {
     case 18: {$perpage=$tmp; break;}
     case 36: {$perpage=$tmp; break;}
     case 72: {$perpage=$tmp; break;}
     default : {$perpage=18; break;}
    }
    return $perpage;
 }
 ...
 function glob_defineSort($tmp)
 {
    switch ($tmp)
    {
     case 'asc': {$res=$tmp; break;}
     case 'desc': {$res=$tmp; break;}
     default : {$res=''; break;}
    }
    return $res;
 }
...
//$res .='('.$tmp.') AND ';
  ...
  if ($res!=='') $res = substr($res,0,strlen($res)-5);
//    echo $res; exit;
  return $res;
 }
...
function glob_makeEntrance($prod)
{
 ...
 else return glob_makeOtherEntrance($prod);
